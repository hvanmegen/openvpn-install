...
function installQuestions() {
	...
	echo "The git repository is available at: https://github.com/hvanmegen/openvpn-install"
	echo ""
	...
	echo "See https://github.com/hvanmegen/openvpn-install#security-and-encryption to learn more."
	echo ""
